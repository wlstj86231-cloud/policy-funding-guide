...
function pageHtml(fund, related) {
  ...
  const boribayBridgeHtml = boribayBridge
    ? `<div class="side-card boribay-side" data-boribay-bridge="${boribayBridge.kind}">
        ...
        <a href="${escapeHtml(boribayBridge.href)}" target="_blank" rel="noopener"><span>${escapeHtml(boribayBridge.cta)}</span><span aria-hidden="true">↗</span></a>
      </div>`
    : "";
  const schema = {
